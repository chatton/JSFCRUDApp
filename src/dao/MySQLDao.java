...
import beans.Region;
import dao.dbinterfaces.CityDBInterface;
...
public class MySQLDao {
	...
	private final CityDBInterface cityDBinterface; // city db interactions.

	public MySQLDao() {
		connect();
		this.countryDBinterface = new CountryDBInterface();
		this.regionDBinterface = new RegionDBInterface();
		this.cityDBinterface = new CityDBInterface();
	}
...
//	}
	...
	public List<City> getAllCities() throws SQLException {
		return cityDBinterface.getAllCities(connection);
	}
	...
	public List<Country> loadAllCountries() throws SQLException {
		return countryDBinterface.loadAll(connection);
	}

	public String executeUpdate(Country country) throws SQLException{
		return countryDBinterface.executeUpdate(country, connection);
